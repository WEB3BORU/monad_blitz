...
class BitcoinService {
    ...
    async getBitcoinHdWalletBalances(walletAddress, queryParamOpts) {
        const endpoint = endpointGenerator(`${ChainName.BTC_MAINNET}/address/${walletAddress}/hd_wallets`, [
            {
                key: "quote-currency",
                value: queryParamOpts?.quoteCurrency,
            },
    ...
    async getBitcoinNonHdWalletBalances(walletAddress, queryParamOpts) {
        const endpoint = endpointGenerator(`${ChainName.BTC_MAINNET}/address/${walletAddress}/balances_v2`, [
            {
                key: "quote-currency",
                value: queryParamOpts?.quoteCurrency,
            },
